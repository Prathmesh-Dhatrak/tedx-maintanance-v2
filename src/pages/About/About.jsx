  ...
  return (
    <>
        ...
        <div className="AboutPage" style={pageStyle}>
            ...
            >
              <div className={styles.content}>
                ...
                <p>
                  ...
                  solely believe in the power of ideas to change attitudes,
                  lives, and ultimately, the world at large. We're bringing
                  together people from all different walks of life to come,
                  confer and confabulate ideas in whole different dimensions.
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            className={styles.about_pillars_title}
            style={{
              marginBottom: "60px",
            }}
          >
          ...
          <div className={styles.new_about_ted}>
            <div className={styles.new_about_ted_left}>
              ...
              <p>
                ...
                Spreading. It started as a four-day conference in California 30
            ...
            <div className={styles.new_about_ted_right}>
              ...
              <p>
                ...
                events conducted till now are more than 6000. Many of these
              ...
              <p>
                ...
                power of ideas, thus forming a trinity of ideas from-
                Technology, Entertainment, and Design, and has recently taken up
                a broader scope ranging from science and business to global
                issues in more than a 100 languages.
              </p>
            </div>
          </div>
          ...
          <div className={styles.new_about_tedx}>
            <div className={styles.new_about_tedx_left}>
              ...
              <p>
                ...
                program of local, self-organised events that bring people
                together to share a TED-like experience. These events are
                open-source and local-community driven organised by passionate
                individuals who seek to uncover new ideas and share the latest
                research in their local areas that spark conversations in their
                communities and ultimately elevate them to a global stage.
              </p>
            </div>
          ...
          <div className={styles.new_tedxVitpune}>
            ...
            <p>
              ...
              Worth Spreading', within its local community. Over the past eight
            ...
            <p>
              ...
              has garnered an extensive following around the country and has
              been recognized as an exemplary TEDx event in India.
            </p>
          </div>
          ...
          <div className={styles.about_ideas}>
            ...
            <p>
              ...
              encourage, inspire and hold the power to bring individuals
              together and bridge the gaps between communities.
            </p>
          ...
          <div className={styles.about_community}>
            ...
            <p>
              ...
              engagement all throughout the year, our local community partakes
              in novel initiatives, taken to share striking ideas.
            </p>
            <p>
